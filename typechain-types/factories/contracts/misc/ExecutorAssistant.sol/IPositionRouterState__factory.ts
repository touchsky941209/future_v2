    ...
    outputs: [
      {
        ...
        internalType: "struct IPositionRouter.DecreaseLiquidityPositionRequest",
        name: "",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct IPositionRouter.IncreaseLiquidityPositionRequest",
        name: "",
        type: "tuple",
      },
    ],
...
export class IPositionRouterState__factory {
  ...
  static createInterface(): IPositionRouterStateInterface {
    return new Interface(_abi) as IPositionRouterStateInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPositionRouterState;
  }
}
