...
import type {
  IMarketPosition,
  IMarketPositionInterface,
} from "../../../../contracts/core/interfaces/IMarketPosition";
...
export class IMarketPosition__factory {
  static readonly abi = _abi;
  static createInterface(): IMarketPositionInterface {
    return new Interface(_abi) as IMarketPositionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IMarketPosition {
    return new Contract(address, _abi, runner) as unknown as IMarketPosition;
  }
}
