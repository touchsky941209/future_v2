...
export interface MarketManagerStatesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "USD"
      | "acceptGov"
...
export interface MarketManagerStates extends BaseContract {
  connect(runner?: ContractRunner | null): MarketManagerStates;
  waitForDeployment(): Promise<this>;

  interface: MarketManagerStatesInterface;
