...
export interface MixedExecutorV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptGov"
  ...
  encodeFunctionData(
    functionFragment: "pythAdaptor",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "pythPriceFeed",
    values?: undefined
  ): string;
...
export interface MixedExecutorV2 extends BaseContract {
  connect(runner?: ContractRunner | null): MixedExecutorV2;
  ...
  pythAdaptor: TypedContractMethod<[], [string], "view">;

  pythPriceFeed: TypedContractMethod<[], [string], "view">;
  ...
  setPriceX96s: TypedContractMethod<
    [
      _packedPythPrices: BigNumberish[],
      _packedPrices: BigNumberish[],
      _packedMinPublishTimes: BigNumberish,
  ...
  getFunction(
    nameOrSignature: "pythAdaptor"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
    nameOrSignature: "pythPriceFeed"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
