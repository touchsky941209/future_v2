...
export interface IPriceFeedInterface extends Interface {
  ...
  getEvent(
    nameOrSignatureOrTopic: "MaxCumulativeDeltaDiffExceeded" | "PriceUpdated"
  ): EventFragment;
...
export interface IPriceFeed extends BaseContract {
  ...
  calculatePriceX96s: TypedContractMethod<
    [marketPrices: IPriceFeed.MarketPriceStruct[]],
  ...
  sequencerUptimeFeed: TypedContractMethod<[], [string], "nonpayable">;
  ...
  setMaxCumulativeDeltaDiffs: TypedContractMethod<
    [market: AddressLike, maxCumulativeDeltaDiff: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  setStableMarketPriceFeed: TypedContractMethod<
    [
      stableMarketPriceFeed: AddressLike,
      stableMarketPriceFeedHeartBeatDuration: BigNumberish
    ],
    [void],
    "nonpayable"
  >;
  ...
  ): TypedContractMethod<[updateTxTimeout: BigNumberish], [void], "nonpayable">;
  getFunction(
