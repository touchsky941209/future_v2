...
contract PriceFeed is IPriceFeed, Governable {
    ...
    ) external pure returns (uint160[] memory minPriceX96s, uint160[] memory maxPriceX96s) {
    ...
    /// @inheritdoc IPriceFeed
    function setPriceX96s(MarketPrice[] calldata _marketPrices) external override onlyUpdater {
